...
import {
  ...
  withDirectives,
  withModifiers
} from "./chunk-AFY2WA6J.js";

// node_modules/element-plus/es/components/popper/src/constants.mjs
var POPPER_INJECTION_KEY = /* @__PURE__ */ Symbol("popper");
var POPPER_CONTENT_INJECTION_KEY = /* @__PURE__ */ Symbol("popperContent");
...
var FORWARD_REF_INJECTION_KEY = /* @__PURE__ */ Symbol("elForwardRef");
...
var formContextKey = /* @__PURE__ */ Symbol("formContextKey");
var formItemContextKey = /* @__PURE__ */ Symbol("formItemContextKey");
...
var TOOLTIP_INJECTION_KEY = /* @__PURE__ */ Symbol("elTooltip");
...
var ID_INJECTION_KEY = /* @__PURE__ */ Symbol("elIdInjection");
var useIdInjection = () => {
...
var usePopperContainer = () => {
  ...
  onBeforeMount(() => {
    if (!isClient)
      return;
    if (typeof process !== "undefined" && false || !document.body.querySelector(selector.value)) {
...
var scrollbarContextKey = /* @__PURE__ */ Symbol("scrollbarContextKey");
...
var useFormDisabled = (fallback) => {
  ...
  return computed(() => {
    var _a2, _b, _c;
    return (_c = (_b = (_a2 = disabled.value) != null ? _a2 : unref(fallback)) != null ? _b : form == null ? void 0 : form.disabled) != null ? _c : false;
  });
};
...
var selectGroupKey = /* @__PURE__ */ Symbol("ElSelectGroup");
var selectKey = /* @__PURE__ */ Symbol("ElSelect");
...
var useSelect = (props, emit) => {
  ...
  const dropdownMenuVisible = computed({
    get() {
      return expanded.value && (props.loading || !isRemoteSearchEmpty.value) && (!debouncing.value || !isEmpty2(states.previousQuery));
    },
    set(val) {
      expanded.value = val;
    }
  ...
  const toggleMenu = (event) => {
    var _a2;
    if (selectDisabled.value || props.filterable && expanded.value && event && !((_a2 = suffixRef.value) == null ? void 0 : _a2.contains(event.target)))
      return;
    if (isIOS)
  ...
  const focusOption = (targetIndex, mode) => {
    ...
    const newIndex = (_a2 = findFocusableIndex(options, start, direction, len)) != null ? _a2 : findFocusableIndex(options, start - direction, -direction, len);
    if (newIndex != null) {
...
var OptionGroup = _export_sfc(_sfc_main17, [["render", _sfc_render4], ["__file", "option-group.vue"]]);
...
var createSelectWarnHandler = (appContext) => {
  return (...args) => {
    ...
    if (!message || message.includes('Slot "default" invoked outside of the render function') && ((_a2 = args[2]) == null ? void 0 : _a2.includes("ElTreeSelect")))
      return;
...
var Select = _export_sfc(_sfc_main18, [["render", _sfc_render5], ["__file", "select.vue"]]);
...
//# sourceMappingURL=chunk-N23UKWIR.js.map
